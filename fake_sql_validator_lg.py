...
prompt = ChatPromptTemplate.from_messages([
    SystemMessagePromptTemplate.from_template(
        ...
        1. Generate a short SQL-related message that intentionally triggers that error.
...
if __name__ == '__main__':
    ...
    temp = compiled_graph.invoke({'question': 'This SQL has a hullicated error', 'messages': [], 'results': {}})
